...
<div class="row">
    <div class="col-md-12">
		...
		<h1><center>OUR CURRENT PRODUCTS:</center></center></h1>
                <div class="col-md-12">
		            <div id="container">
		                <?php include "include/productspicture.php"; ?>
		            </div>
	            </div>
	    </div>
	</div>
        ...
        <div id="container">
                ...
                <div class="col-lg-4">
				        <p><strong>1. Soil Fertility:</strong></p>
				               <img src="assets/slides/products/mainproduct/soilfertilty.jpg" style="width:531px;height:150px;" alt="" class="img-responsive pull-left" >
							    <p> 
				 ...
				 <div class="col-lg-4">
				        <p><strong>2. Crop Nutrition</strong></p>
				        <img src="assets/slides/products/crop_nutrition_products/cropnutrition.jpg" style="width:361px;height:180px;" alt="" class="img-responsive pull-left" >
				            </br>
						    <p>
	                            ...
	                            <p>Solution:</p>
	                                <ol>
	                                    <li>Prime EC Foliar Plant Food by Wanda Organic </li>   	
	                                </ol>
				</div>

				<div class="col-sm-4">
				        <p><strong>3. Animal Nutrition</strong></p>
				        <img src="assets/slides/products/animal_products/animal2.jpg" style="width:431px;height:180px;" alt="" class="img-responsive pull-left" >
						    <p>
						        Meeting livestock nutritional requirements is extremely important in maintaining acceptable performance of neonatal, growing, finishing and breeding animals. There are seven major classes of nutrients: carbohydrates, fats, fibre, minerals, protein, vitamin, and water.
	                        </P>
	                        <table>
	                            <p>Solution:</p>
	                                <ol>
	                                    <li>Dairy Meals by Bidco LandOLakes</li>
	                                    <li>Grow Broilers by Bidco LandOLakes</li> 
	                                    <li>Kienyeji Mash by Bidco LandOLakes</li>
	                                    <li>Swine Meals by Bidco LandOLakes</li>   
	                                </ol>
	                        </table>
				</div>

				<div class="col-lg-4">
				        <p><strong>4. Seeds</strong></p>
				         <img src="assets/slides/products/seeds_products/seeds.jpg" style="width:431px;height:180px;" alt="" class="img-responsive pull-left" >
						    <p>
                ...
                <div class="col-lg-4">
				        <p><strong>5. Crop Protection</strong></p>
				        <img src="assets/slides/products/crop_protection_products/cropproction.jpg" style="width:431px;height:180px;" alt="" class="img-responsive pull-left" >
						    <p>
	                            ...
	                            <p>Solution:</p>
	                                <ol>
	                                    <li>Fungicides by Syngenta</li>
	                                    <li>Pesticides by Syngenta</li>   
	                                    <li>Herbicides by Syngenta</li>
	                                    <li>Pesticides by Syngenta</li>  
	                                    <li>Biological Controls by Kenya Biologics</li>                 	
	                                </ol>
				</div>

				<div class="col-lg-4">
				        <p><strong>6. Customer Care </strong></p>
				        <img src="assets/slides/products/team_customercare/customercare1.jpg" style="width:431px;height:190px;" alt="" class="img-responsive pull-left" >
						    <p>
